"""
Django settings for patiodate_41908 project.
...
ROOT_URLCONF = 'patiodate_41908.urls'
...
WSGI_APPLICATION = 'patiodate_41908.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patiodate_41908 API",
    "DESCRIPTION": "API documentation for patiodate_41908 App",
    "VERSION": "v1",
}
